...
FILES = [
    ...
    ("assets/js/sources.js", "javascript"),
    ("assets/js/data.js", "javascript"),
    ("assets/js/ui.js", "javascript"),
    ("assets/js/scorecard.js", "javascript"),
    ("assets/js/alerts.js", "javascript"),
    ("assets/js/events.js", "javascript"),
    ("assets/js/compare.js", "javascript"),
    ("assets/js/app.js", "javascript"),
    ("server.py", "python"),
    ("tsepy/tsetmc_live.py", "python"),
    ("tsepy/bourse_trader.py", "python"),
    ("tools/fetch_live_snapshot.py", "python"),
    ("main.py", "python"),
